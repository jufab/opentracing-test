 ...
 */
  ...
  function drawList(noResultsMsg) {
    ...
    //Some browser, eg IE,  doesn't url encode special chars, thus can result in XSS. 
    //We will just do this for all browser instead of trying to differentiate which browser is used.
    args['searchQuery'] = encodeURI(args['searchQuery']);
